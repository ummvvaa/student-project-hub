    ...
    <div className="flex items-start gap-3 rounded-xl border border-gray-200 bg-white p-3">
      ...
      <div className="min-w-0 flex-1 space-y-1.5">
        <input
          ...
          className="w-full rounded-lg border border-transparent bg-gray-50 px-2 py-1 text-sm font-medium text-gray-900 focus:border-indigo-300 focus:bg-white focus:outline-none"
      ...
      <div className="flex flex-shrink-0 items-center gap-1">
        ...
        <input
          ...
          className="w-12 rounded-lg border border-gray-200 bg-white px-1.5 py-1 text-center text-sm text-gray-700 focus:border-indigo-300 focus:outline-none"
        />
        <span className="text-xs text-gray-400">д.</span>
      </div>

      <div className="flex-shrink-0 rounded-full bg-indigo-50 px-2 py-0.5 text-xs font-medium text-indigo-600">
        {index + 1}
      </div>
    </div>
  );
